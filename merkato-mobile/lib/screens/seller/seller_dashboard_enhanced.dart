...
class SellerDashboardEnhanced extends ConsumerStatefulWidget {
  const SellerDashboardEnhanced({super.key});

  @override
  ConsumerState<SellerDashboardEnhanced> createState() => _SellerDashboardEnhancedState();
}

class _SellerDashboardEnhancedState extends ConsumerState<SellerDashboardEnhanced> {
  int _currentIndex = 0;
